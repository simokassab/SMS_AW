...
/* Error Page */
    ...
    {
        width: 230px;   /*Contrall play with javascript*/ 
    }
            ...
            <div class="error">
                <div class="container-floud">
                    <div class="col-xs-12 ground-color text-center">
                        ...
                        <br/><hr>
                        <h2 class="h1">Sorry! Your requested page not found</h2>
                        <a href="./" class="btn btn-secondary btn-lg a-btn-slide-text" >
    ...
    function randomNum()
        {
            ...
            var loop1,loop2,loop3,time=15, i=0, number, selector3 = document.querySelector('.thirdDigit'), selector2 = document.querySelector('.secondDigit'),
